package eu.getsoftware.hotelico.client.adapter.out.persistence.outPortServiceImpl;

import eu.getsoftware.hotelico.client.adapter.out.persistence.model.MenuItemMappedEntity;
import eu.getsoftware.hotelico.client.adapter.out.persistence.model.MenuOrderMappedEntity;
import eu.getsoftware.hotelico.client.adapter.out.persistence.repository.MenuItemRepository;
import eu.getsoftware.hotelico.client.adapter.out.persistence.repository.MenuOrderRepository;
import eu.getsoftware.hotelico.client.application.port.out.IMenuPortService;
