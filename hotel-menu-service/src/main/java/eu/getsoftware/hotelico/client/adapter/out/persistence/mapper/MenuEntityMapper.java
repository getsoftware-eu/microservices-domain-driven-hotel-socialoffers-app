package eu.getsoftware.hotelico.client.adapter.out.persistence.mapper;

import eu.getsoftware.hotelico.client.adapter.out.persistence.model.MenuOrderMappedEntity;
import eu.getsoftware.hotelico.client.application.domain.model.MenuOrderRootDomainEntity;
