...
public interface ChatRepository extends JpaRepository<ChatMessage, Long> {
	...
	public List<CustomerRootEntity> getChatSendersByCustomerId(@Param("customerId") Long customerId);	
	
	@Query(FIND_CHAT_RECEIVER_BY_CUSTOMER_ID)
	public List<CustomerRootEntity> getChatReceiversByCustomerId(@Param("customerId") Long customerId);
