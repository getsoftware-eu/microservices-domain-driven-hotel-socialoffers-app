...
class MenuOrderDTO: BasicDTO
{
    ...
    fun getPreviewPictureUrl(): String {
        return previewPictureUrl ?: eu.getsoftware.hotelico.hotel.utils.ControllerUtils.PREVIEW_MENU_NOT_AVAILABLE_URL
    }
    ...
    fun getTimeString(): String? {
        return if (timestamp != null) eu.getsoftware.hotelico.hotel.utils.ControllerUtils.getTimeFormatted(timestamp) else null
    }
