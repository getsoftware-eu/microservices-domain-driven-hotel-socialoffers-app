...
class CustomerDTO : BasicDTO
{
    ...
    fun getProfileImageUrl(): String? {
        return eu.getsoftware.hotelico.hotel.utils.ControllerUtils.addHostPrefixOnDemand(profileImageUrl)
    }
    ...
    fun getAvatarUrl(): String? {
        return eu.getsoftware.hotelico.hotel.utils.ControllerUtils.addHostPrefixOnDemand(avatarUrl)
    }
    ...
    fun isFullCheckin(): Boolean {
        return fullCheckin || eu.getsoftware.hotelico.hotel.utils.ControllerUtils.CHECKIN_FULL_ALWAYS
    }  
