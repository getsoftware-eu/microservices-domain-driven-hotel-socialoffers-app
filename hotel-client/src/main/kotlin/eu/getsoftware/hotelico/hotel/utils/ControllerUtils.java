package eu.getsoftware.hotelico.hotel.utils;
...
//	public static final String EVENT_CHAT_MESSAGE = "EVENT_CHAT_MESSAGE";
	...
	public static boolean isCustomerOnline(Customer customer)
	{
		return customer!=null && (customer.isHotelStaff() || customer.getLastSeenOnline()!=null && customer.getLastSeenOnline().after(convertToDate(LocalDateTime.now().minusMinutes(25))));
	}
