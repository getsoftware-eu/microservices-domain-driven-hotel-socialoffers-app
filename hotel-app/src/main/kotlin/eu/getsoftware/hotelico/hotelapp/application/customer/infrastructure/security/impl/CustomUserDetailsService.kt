package eu.getsoftware.hotelico.hotelapp.application.customer.infrastructure.security.impl//package eu.getsoftware.hotelico.clients.infrastructure.service.security.impl

import eu.getsoftware.hotelico.hotelapp.adapter.out.persistence.customer.repository.UserRolesRepository
import eu.getsoftware.hotelico.hotelapp.application.customer.infrastructure.security.CustomUserDetails
