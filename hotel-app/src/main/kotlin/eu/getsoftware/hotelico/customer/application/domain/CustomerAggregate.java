package eu.getsoftware.hotelico.customer.application.domain;

import eu.getsoftware.hotelico.customer.adapter.out.persistence.model.CustomerRootEntity;
import eu.getsoftware.hotelico.customer.adapter.out.persistence.model.CustomerRootEntity.CustomerRootEntityBuilder;
import eu.getsoftware.hotelico.customer.application.domain.model.ICustomerDetails;
import eu.getsoftware.hotelico.customer.application.domain.model.ICustomerPreferences;
