package eu.getsoftware.hotelico.customer.application.domain.infrastructure.security.impl//package eu.getsoftware.hotelico.clients.infrastructure.service.security.impl

import eu.getsoftware.hotelico.customer.adapter.out.persistence.repository.UserRolesRepository
import eu.getsoftware.hotelico.customer.application.domain.infrastructure.security.CustomUserDetails
import eu.getsoftware.hotelico.hotel.application.port.`in`.iService.IUserService
