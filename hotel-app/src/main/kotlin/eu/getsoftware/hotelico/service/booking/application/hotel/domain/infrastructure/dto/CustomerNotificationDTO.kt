...
//	private String[] newHotelCustomers;
    ...
    fun setCustomerEvent(customerId: Long, hotelId: Long, event: eu.getsoftware.hotelico.service.booking.adapter.out.persistence.hotel.model.InnerHotelEvent, message: String, entityId: Long) {
