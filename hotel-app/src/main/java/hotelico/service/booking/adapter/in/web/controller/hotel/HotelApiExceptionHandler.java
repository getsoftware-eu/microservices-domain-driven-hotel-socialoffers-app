package hotelico.service.booking.adapter.in.web.controller.hotel;

import eu.getsoftware.hotelico.clients.api.application.infrastructure.exception.ApiErrorResponse;
import hotelico.service.booking.application.hotel.domain.infrastructure.error.HotelNotFoundException;
