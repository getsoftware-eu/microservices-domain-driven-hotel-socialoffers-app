package hotelico.service.booking.application.hotel.domain.model.customDomainModelImpl;
...
import hotelico.service.booking.application.hotel.domain.model.IHotelWallPost;
import lombok.*;
...
//    @JsonView(HotelPartialUpdateView.class)
    ...
    //eugen: mappedBy entity!
    Set<HotelRootDomainEntity> hotelActivities;
