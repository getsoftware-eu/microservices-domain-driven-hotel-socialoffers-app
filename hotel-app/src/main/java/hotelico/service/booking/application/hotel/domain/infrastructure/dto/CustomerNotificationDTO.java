...
public class CustomerNotificationDTO {
     ...
     */
    private Map<Long, String> lastMessagesToMe;

    /**
     * last message time from every sender to customer
     */
    private Map<Long, String> lastMessageTimesToMe;

    private Map<Long, Boolean> lastMessageSeenByCustomer;

    private Map<Long, Boolean> lastMessageDeliveredToCustomer;
