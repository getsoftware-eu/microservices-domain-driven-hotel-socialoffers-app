...
import eu.getsoftware.hotelico.service.booking.application.hotel.port.out.iPortService.MailService;
...
//			}
		...
		if(hotel!=null)
		{
			...
			List<HotelActivityDTO> hotelActivities = hotelService.getHotelActivitiesByHotelId(null, hotel.getDomainEntityId());
