...
public class HotelWallRootDomainEntity implements IRootDomainEntity<WallPostDomainEntityId> /*MultitenantDocument, Scoreable*/ {
    
    public static final String TYPE_NAME = "hotel";

    @NonNull  
    public WallPostDomainEntityId domainEntityId;
...
//    @JsonView(HotelPartialUpdateView.class)
    ...
    //eugen: mappedBy entity!
    Set<HotelWallRootDomainEntity> hotelActivities;
...
//    }
    ...
    @Override
    public WallPostDomainEntityId getDomainEntityId() {
