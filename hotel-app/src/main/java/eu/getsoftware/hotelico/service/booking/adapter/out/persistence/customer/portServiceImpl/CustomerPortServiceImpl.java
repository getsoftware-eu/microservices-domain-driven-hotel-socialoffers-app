...
//        aggregate.setLogged(true);
        ...
        {
            notificationService.notificateAboutEntityEvent(dto, InnerHotelEvent.EVENT_REGISTER, "Now Registered!", dto.getDomainEntityId());
        }
...
//    @Override
    public void deleteCustomer(CustomerDTO customerDto) {
        customerRepository.deleteById(customerDto.getCustomerConsistencyId());
    }
