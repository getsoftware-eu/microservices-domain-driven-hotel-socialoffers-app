...
//    public @ResponseBody
//    CustomerDTO getCustomerId(@PathVariable("customerId") CustomerDomainEntityId customerId) {
////        doList()
//        return getCustomers().stream().findAny().orElseGet(() -> CustomerDTO.builder().domainEntityId(customerId).build());
//    }    
...
//        doList()
    ...
    @RequestMapping(value = "/{customerId}/hotel/{hotelId}/addStaff/{addStaff}", method = RequestMethod.GET)
    public @ResponseBody
    ...
    @RequestMapping(value = "/{customerId}/city/{city}", method = RequestMethod.GET)
    public @ResponseBody
    ...
    // @NotifyClients
    @RequestMapping(value = "/{id}/requesterId/{requesterId}", method = RequestMethod.PUT)
...
//        customerDTO.setId(id);
    ...
    @RequestMapping(value = "/{id}/requesterId/{requesterId}", method = RequestMethod.GET)
...
//            out.setErrorResponse("Connection error: " + e.getMessage());
    ...
    @NotifyClients
    @RequestMapping(value = "/{id}/requesterId/{requesterId}", method = RequestMethod.DELETE)
